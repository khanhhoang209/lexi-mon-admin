...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className='h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 flex'>
      {/* Sidebar */}
      <div className='w-72 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 shadow-2xl flex flex-col relative overflow-hidden'>
        ...
        <div className='p-6 border-b border-slate-700/50 relative z-10'>
          <div className='flex items-center space-x-3'>
            ...
            <div>
              <h1 className='text-xl font-bold text-white'>LexiMon</h1>
        ...
        {/* Navigation */}
        <nav className='flex-1 p-4 overflow-y-auto relative z-10 scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-transparent'>
        ...
        <div className='p-4 border-t border-slate-700/50 relative z-10'>
          <div className='bg-slate-800/50 backdrop-blur-sm rounded-xl p-3 mb-3'>
            <div className='flex items-center space-x-3'>
          ...
          <button
            ...
            className='w-full flex items-center justify-center px-4 py-3 rounded-xl bg-red-500/10 text-red-400 hover:bg-red-500/20 hover:text-red-300 transition-all duration-200 group'
          >
            <svg
