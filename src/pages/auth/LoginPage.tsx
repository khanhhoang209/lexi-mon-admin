            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
              ...
              <div className='relative'>
                <input
                  ...
                  className='w-full px-4 py-3 bg-white/90 border-0 rounded-lg placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:bg-white transition-all pr-12'
